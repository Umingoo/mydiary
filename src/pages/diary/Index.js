  ...
  return (
    <>
      <Header handleClickMenu={handleClickMenu} icon="bt_back.svg">
        <h2 style={{ fontWeight: 800, color: "purple" }}>Diary Main</h2>
      </Header>

      <Main>
        <h2 style={{ textAlign: "center", color: "red" }}>다이어리 첫화면</h2>
        <div>
          <h3>배열의 내용을 출력함 : map 메서드 사용 </h3>
          <ul>
            {list.map((elem, index) => {
              return (
                <li
        ...
        <Link to="/diary/add">다이어리 추가가기</Link>
        <br></br>
        <Link to="/diary/edit/1">다이어리 수정가기</Link>
      </Main>
